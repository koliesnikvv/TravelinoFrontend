...
// import { useNavigate, useParams } from 'react-router-dom';
//
// export default function TransportSection({ transport, onDelete, canEdit, onAddFlight }) {
//     const navigate = useNavigate();
//     const { id } = useParams();
//
//     return (
...
//                                 <Box>
//                                     <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
//                                         <Chip label={item.transport_type || 'flight'} size="small" />
//                                         <Typography variant="body1">
//                                             {item.departure_point || item.departure_airport} → {item.arrival_point || item.arrival_airport}
//                                         </Typography>
//                                     </Box>
//                                     <Typography variant="body2" color="text.secondary">
//                                         {item.departure_datetime || item.departure_time}
//                                     </Typography>
//                                     <Typography variant="body2">
//                                         ${item.price} · {item.passengers_count || 1} passenger{(item.passengers_count || 1) !== 1 ? 's' : ''}
//                                     </Typography>
//                                 </Box>
//                                 <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
//                                     <Button
...
//
//             {canEdit && (
//                 <Button variant="outlined" onClick={onAddFlight}>
//                     + Add transport
//                 </Button>
//             )}
//         </Box>
